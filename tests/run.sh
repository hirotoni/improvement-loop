...
if command -v shellcheck >/dev/null 2>&1; then
  ...
  # claude-skills/improvement-dispatcher/scripts/merge-reviewed-branch は bash なので shellcheck が
...
echo ""
echo "=== 8. claude-skills/improvement-dispatcher/scripts/create-worktree の動作確認 ==="
...
echo ""
echo "=== 9. claude-skills/improvement-dispatcher/scripts/create-worktree の worktree_base_dir カスタム設定での動作確認 ==="
